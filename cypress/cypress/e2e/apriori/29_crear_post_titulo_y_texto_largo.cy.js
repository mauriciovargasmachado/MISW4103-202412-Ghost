describe('Funcionalidad: Crear páginas', () => {
    ...
    it('Crear una página con título que empieza con puntos y una descripción de 263 palabras y programar su publicación.', ()=>{
      ...
      cy.get('.gh-editor-title.ember-text-area.gh-input.ember-view').type(dataPool.title_with_points)
      
      cy.wait(1000)
      cy.get('.kg-prose').click()
      cy.wait(1000)
      
      cy.get('p[data-koenig-dnd-droppable="true"]').type(dataPool.long_body);
      cy.wait(1000)
