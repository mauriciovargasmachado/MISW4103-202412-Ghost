describe('Funcionalidad: Crear post', () => {
    ...
    it('Crear post con titulo vacio, descripcion y divider', ()=>{
        ...
        cy.get('.gh-editor-title.ember-text-area.gh-input.ember-view').type(dataPool.empty_title)
        cy.wait(3000)
        ...
        cy.get('.kg-prose').type(dataPool.body)
