describe('Funcionalidad: Crear páginas', () => {
  ...
  it('Crear una página con números en el título y publicarla directamente.', () => {
    ...
    cy.get('.gh-editor-title.ember-text-area.gh-input.ember-view').type(dataPool.title_numbers)
    cy.wait(1000)
