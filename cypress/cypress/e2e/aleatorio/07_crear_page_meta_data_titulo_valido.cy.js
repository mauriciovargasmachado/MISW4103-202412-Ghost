...
describe('Funcionalidad: Crear páginas', () => {
  ...
  it('Crear una página con título y cuerpo válido, con un meta data title válido y publicarla directamente.', () => {
    ...
    cy.wait(1000)
    cy.get("#meta-title").type(faker.string.alpha({ length: { min: 1, max: 300 } }))
