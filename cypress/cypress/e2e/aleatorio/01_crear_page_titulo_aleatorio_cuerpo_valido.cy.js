...
describe('Funcionalidad: Crear páginas', () => {
  ...
  it('Crear una página con título aleatorio y cuerpo válido y publicarla directamente.', () => {
    ...
    cy.get('.gh-editor-title.ember-text-area.gh-input.ember-view').type(faker.string.alpha({ length: { min: 1, max: 256 }}))
    cy.wait(1000)
