...
describe('Funcionalidad: Crear draf', () => {
    ...
    it('Crear un draft que edite la descripcion de x', ()=>{
      ...
      cy.get('.post-setting-twitter-title.ember-text-field.gh-input.ember-view').type(generate_tittle(words_in_tittle))
      cy.wait(6000)

      //And I edit x description
      let x_description = generate_description(words_in_description)
      cy.get('.post-setting-twitter-description.ember-text-area.gh-input.ember-view').type(x_description)
      cy.wait(6000)
      ...
      //Then I expect to see x description field filled
      cy.get('.post-setting-twitter-description.ember-text-area.gh-input.ember-view').should('have.value', x_description);
    });
  });