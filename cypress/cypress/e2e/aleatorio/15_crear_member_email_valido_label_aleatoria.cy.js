...
describe("Funcionalidad: Crear miembro", () => {
  ...
  it("Crear un miembro con campos email valido y label aleatorio", () => {
    ...
    cy.wait(3000);
    cy.get('input.ember-power-select-trigger-multiple-input').type(faker.string.alpha({ length: { min: 1, max: 20 }}));
    cy.wait(3000);
