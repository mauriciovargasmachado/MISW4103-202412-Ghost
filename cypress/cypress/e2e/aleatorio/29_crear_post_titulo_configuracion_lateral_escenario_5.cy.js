...
describe('Funcionalidad: Crear post', () => {
    ...
    it('Crear post con titulo, descripcion, divider, excerpt y code injection', ()=>{

        //When I create a new post wih title, description, divider, excerpt and code injection 
        cy.wait(2000)
        ...
        cy.wait(5000)
        cy.get('button[data-test-button="codeinjection"]').eq(0).click()
        cy.wait(5000)
