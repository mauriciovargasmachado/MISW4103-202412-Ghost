...
describe('Funcionalidad: Crear páginas', () => {
  ...
  it('Crear una página con título y cuerpo válido, con un twitter card con título inválido y publicarla directamente.', () => {
    ...
    cy.wait(1000)
    cy.get("#twitter-title").type(faker.string.alpha({ length: { min: 301, max: 500 } }))
    ...
    expect(cy.contains(Cypress.env('TWITTER_CARD_ERROR_MESSAGE')))
  })
})