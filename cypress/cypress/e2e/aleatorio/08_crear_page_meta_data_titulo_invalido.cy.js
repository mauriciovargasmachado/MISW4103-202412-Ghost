...
describe('Funcionalidad: Crear páginas', () => {
  ...
  it('Crear una página con título y cuerpo válido, con un meta data title inválido y publicarla directamente.', () => {
    ...
    cy.wait(1000)
    cy.get("#meta-title").type(faker.string.alpha({ length: { min: 301, max: 500 } }))
    ...
    expect(cy.contains(Cypress.env('META_DATA_ERROR_MESSAGE')))
  })
})