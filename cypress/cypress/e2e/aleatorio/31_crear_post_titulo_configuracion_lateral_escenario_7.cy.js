...
describe('Funcionalidad: Crear post', () => {
    ...
    it('Crear post con titulo, descripcion, divider, excerpt, feature post y metadata', ()=>{

        //When I create a new post wih title, description, divider, excerpt,  feature post and metadata
        cy.wait(2000)
        ...
        cy.wait(2000)
        cy.get('textarea[name="post-setting-custom-excerpt"]').type(`${faker.lorem.words(10)}{enter}`)
        cy.wait(5000)
        cy.get('label[class="switch"]').eq(0).click()
        cy.wait(5000)
        cy.get('button[data-test-button="meta-data"]').eq(0).click()
        cy.wait(5000)
        cy.get('input[name="post-setting-meta-title"]').type(faker.lorem.words(5))
        cy.wait(5000)
        cy.get('textarea[name="post-setting-meta-description"]').type(faker.lorem.words(10))
        cy.wait(5000)
        cy.get('input[name="post-setting-canonicalUrl"]').type(faker.internet.url())
        cy.wait(5000)
        cy.get('button[title="Settings"]').eq(0).click()
        cy.wait(2000)
