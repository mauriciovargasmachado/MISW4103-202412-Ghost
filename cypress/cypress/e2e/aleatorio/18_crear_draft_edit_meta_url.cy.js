...
describe('Funcionalidad: Crear draf', () => {
    ...
    it('Crear un draft que edite la meta URL', ()=>{
      ...
      cy.get('.post-setting-canonicalUrl.ember-text-field.gh-input.ember-view').type(faker.internet.url())
      cy.wait(6000)
      ...
      //Then I expect to see meta url
      cy.get('.post-setting-canonicalUrl.ember-text-field.gh-input.ember-view').should('not.have.value', '');
    });
  });