...
describe('Funcionalidad: Crear tag', () => {
    ...
    it('Crear tag con metadata, twitter card incompleto y facebook incompleto', () => {
        
      //When I create a new tag with a title, incomplate metadata and incomplate twitter and incomplate facebook
      cy.wait(2000)
