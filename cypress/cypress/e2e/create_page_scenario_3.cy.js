describe('Funcionalidad: Crear páginas', () => {
  ...
  it('Crear una página con título pero sin cuerpo y publicarla directamente.', ()=>{
    ...
    // Fill the page form with <VALID_PAGE_TITLE> and <EMPTY_PAGE_BODY>
    ...
    cy.screenshot('create_page_scenario_3/10', {overwrite: true})
    cy.wait(3000)
    cy.get('button.gh-btn.gh-btn-black.gh-btn-large').click()
    cy.screenshot('create_page_scenario_3/11', {overwrite: true})
    cy.wait(3000)
    cy.get('button.gh-btn.gh-btn-large.gh-btn-pulse.ember-view').click()
    cy.screenshot('create_page_scenario_3/12', {overwrite: true})
    cy.wait(5000)
