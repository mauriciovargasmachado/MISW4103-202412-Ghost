describe('Funcionalidad: Crear post', () => {
    ...
    it('Crear post con titulo y email', ()=>{

        //When I create a new post with a title and email
        cy.wait(2000)
        ...
        cy.wait(5000)
        cy.get('.kg-prose').type('/email{enter}')
        cy.wait(5000)
        cy.get('span[data-lexical-text="true"]').filter(':contains(",")').eq(0).type(`${dataPool.short_description}{enter}`)
        cy.wait(5000)
