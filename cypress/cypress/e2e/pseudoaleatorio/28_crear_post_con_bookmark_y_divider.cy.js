describe('Funcionalidad: Crear post', () => {
    ...
    it('Crear post con titulo, divider y bookmark', ()=>{

        //When I create a new post with a title, divider and bookmark
        cy.wait(2000)
        ...
        cy.wait(5000)
        cy.get('.kg-prose').type('/bookmark{enter}')
        cy.wait(5000)
        cy.get('input[placeholder="Paste URL to add bookmark content..."]').type('https://www.google.com/{enter}')
        cy.wait(5000)
