describe('Funcionalidad: Crear post', () => {
    ...
    it('Crear post con titulo, descripcion, divider y header', ()=>{

        //When I create a new post with a title, description, divider and header
        cy.wait(2000)
        ...
        cy.wait(5000)
        cy.get('.kg-prose').type('/header{enter}')
        cy.wait(5000)
