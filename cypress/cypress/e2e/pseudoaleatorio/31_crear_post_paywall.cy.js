describe('Funcionalidad: Crear post', () => {
    ...
    it('Crear post con titulo y paywall', ()=>{

        //When I create a new post with a title and paywall
        cy.wait(2000)
        ...
        cy.wait(5000)
        cy.get('.kg-prose').type('/paywall{enter}').type(`${dataPool.long_description}{enter}`);
        cy.wait(5000)
