...
Scenario: Crear un borrador con titulo y descripcion.
  ...
  And I take a screenshot and save it in "create_draft_scenario_1_old/1"
  ...
  And I take a screenshot and save it in "create_draft_scenario_1_old/4"
  ...
  And I wait for 3 seconds
  And I take a screenshot and save it in "create_draft_scenario_1_old/11"
